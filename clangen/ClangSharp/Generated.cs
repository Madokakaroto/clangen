namespace ClangSharp
{
    ...
    public partial struct CXString
    {
        ...
        {
            string retval = Marshal.PtrToStringAnsi((IntPtr)clang.getCString(this));
    ...
    public static partial class clang
    {
        ...
        public static extern CXErrorCode VirtualFileOverlay_addFileMapping(CXVirtualFileOverlay @param0, string @virtualPath, string @realPath);
        ...
        public static extern CXErrorCode ModuleMapDescriptor_setFrameworkModuleName(CXModuleMapDescriptor @param0, string @name);

        [DllImport(libraryPath, EntryPoint = "clang_ModuleMapDescriptor_setUmbrellaHeader", CallingConvention = CallingConvention.Cdecl)]
        public static extern CXErrorCode ModuleMapDescriptor_setUmbrellaHeader(CXModuleMapDescriptor @param0, string @name);
        ...
        public static extern void CXIndex_setInvocationEmissionPathOption(CXIndex @param0, string @Path);
        ...
        public static extern CXFile getFile(CXTranslationUnit @tu, string @file_name);
        ...
        public static extern CXDiagnosticSet loadDiagnostics(string @file, out CXLoadDiag_Error @error, out CXString @errorString);
        ...
        public static extern CXTranslationUnit createTranslationUnitFromSourceFile(CXIndex @CIdx, string @source_filename, int @num_clang_command_line_args, string[] @clang_command_line_args, uint @num_unsaved_files, out CXUnsavedFile @unsaved_files);

        [DllImport(libraryPath, EntryPoint = "clang_createTranslationUnit", CallingConvention = CallingConvention.Cdecl)]
        public static extern CXTranslationUnit createTranslationUnit(CXIndex @CIdx, string @ast_filename);

        [DllImport(libraryPath, EntryPoint = "clang_createTranslationUnit2", CallingConvention = CallingConvention.Cdecl)]
        public static extern CXErrorCode createTranslationUnit2(CXIndex @CIdx, string @ast_filename, out CXTranslationUnit @out_TU);
        ...
        public static extern CXTranslationUnit parseTranslationUnit(CXIndex @CIdx, string @source_filename, string[] @command_line_args, int @num_command_line_args, out CXUnsavedFile @unsaved_files, uint @num_unsaved_files, uint @options);

        [DllImport(libraryPath, EntryPoint = "clang_parseTranslationUnit2", CallingConvention = CallingConvention.Cdecl)]
        public static extern CXErrorCode parseTranslationUnit2(CXIndex @CIdx, string @source_filename, string[] @command_line_args, int @num_command_line_args, out CXUnsavedFile @unsaved_files, uint @num_unsaved_files, uint @options, out CXTranslationUnit @out_TU);

        [DllImport(libraryPath, EntryPoint = "clang_parseTranslationUnit2FullArgv", CallingConvention = CallingConvention.Cdecl)]
        public static extern CXErrorCode parseTranslationUnit2FullArgv(CXIndex @CIdx, string @source_filename, string[] @command_line_args, int @num_command_line_args, out CXUnsavedFile @unsaved_files, uint @num_unsaved_files, uint @options, out CXTranslationUnit @out_TU);
        ...
        public static extern int saveTranslationUnit(CXTranslationUnit @TU, string @FileName, uint @options);
        ...
        public static extern long Type_getOffsetOf(CXType @T, string @S);
        ...
        public static extern IntPtr codeCompleteAt(CXTranslationUnit @TU, string @complete_filename, uint @complete_line, uint @complete_column, out CXUnsavedFile @unsaved_files, uint @num_unsaved_files, uint @options);
        ...
        public static extern CXRemapping getRemappings(string @path);
        ...
        public static extern int indexSourceFile(CXIndexAction @param0, CXClientData @client_data, out IndexerCallbacks @index_callbacks, uint @index_callbacks_size, uint @index_options, string @source_filename, string[] @command_line_args, int @num_command_line_args, out CXUnsavedFile @unsaved_files, uint @num_unsaved_files, out CXTranslationUnit @out_TU, uint @TU_options);
